...
public final class Constants {
    ...
    public static class IntakeConstants {
        ...
        public static final double ROLLERS_CLOCKWISE = 1;
        public static final double ROLLERS_COUNTERCLOCKWISE = 1;
        public static final double SENSOR_REACHED = .3;
        public static final double PIVOT_CLOCKWISE = 1;
        public static final double PIVOT_COUNTERCLOCKWISE = -1;
        public static final double PAST_SENSOR_TIME = 3;
    }

    /** Constants for the shooter subsystems. */
    ...
    /** Constants for the climb subsystem and climb arms. */
